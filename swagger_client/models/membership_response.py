...
class MembershipResponse(object):
    ...
    @property
    def data(self):
        """Gets the data of this MembershipResponse.  # noqa: E501


        :return: The data of this MembershipResponse.  # noqa: E501
        :rtype: Membership
        """
        return self._data
    ...
    @data.setter
    def data(self, data):
        """Sets the data of this MembershipResponse.


        :param data: The data of this MembershipResponse.  # noqa: E501
        :type: Membership
        """
        if data is None:
