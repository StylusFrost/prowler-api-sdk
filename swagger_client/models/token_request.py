...
class TokenRequest(object):
    ...
    @property
    def data(self):
        """Gets the data of this TokenRequest.  # noqa: E501


        :return: The data of this TokenRequest.  # noqa: E501
        :rtype: TokenRequestData
        """
        return self._data

    @data.setter
    def data(self, data):
        """Sets the data of this TokenRequest.


        :param data: The data of this TokenRequest.  # noqa: E501
