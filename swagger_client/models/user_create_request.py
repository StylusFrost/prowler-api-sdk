...
class UserCreateRequest(object):
    ...
    @property
    def data(self):
        """Gets the data of this UserCreateRequest.  # noqa: E501


        :return: The data of this UserCreateRequest.  # noqa: E501
        :rtype: UserCreateRequestData
        """
        return self._data

    @data.setter
    def data(self, data):
        """Sets the data of this UserCreateRequest.


        :param data: The data of this UserCreateRequest.  # noqa: E501
