...
class UserCreate(object):
    ...
    @property
    def type(self):
        """Gets the type of this UserCreate.  # noqa: E501
        ...
        :return: The type of this UserCreate.  # noqa: E501
        :rtype: AllOfUserCreateType
        """
        return self._type

    @type.setter
    def type(self, type):
        """Sets the type of this UserCreate.

        The [type](https://jsonapi.org/format/#document-resource-object-identification) member is used to describe resource objects that share common attributes and relationships.  # noqa: E501

        :param type: The type of this UserCreate.  # noqa: E501
        :type: AllOfUserCreateType
        """
        if type is None:
