...
class RoleResponse(object):
    ...
    @property
    def data(self):
        """Gets the data of this RoleResponse.  # noqa: E501


        :return: The data of this RoleResponse.  # noqa: E501
        :rtype: Role
        """
        return self._data
    ...
    @data.setter
    def data(self, data):
        """Sets the data of this RoleResponse.


        :param data: The data of this RoleResponse.  # noqa: E501
        :type: Role
        """
        if data is None:
